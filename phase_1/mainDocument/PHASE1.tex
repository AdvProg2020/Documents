...
\item
یکی از اهداف پروژه، آشنایی با برخی ابزارها و Pattern های استاندارد برنامه‌نویسی، مثل ابزار مدیریت و تعریف پروژه‌ٔ \underline{\lr{Apache Maven}}، مبحث \underline{\lr{Unit Test}}، و معماری \underline{\lr{MVC}} می‌باشد.
...
\addcontentsline{toc}{subsection}{{\fehrestContent صفحه اصلی > ناحیه کاربری > (لاگین کرده)}}
...
\addcontentsline{toc}{subsubsection}{{\fehrestContent «صفحهٔ محصول»}}
...
\addcontentsline{toc}{subsubsection}{{\fehrestContent «صفحهٔ حراج‌ها»}}
