...
می‌توانید برای کل قسمت‌ها یا برای هر قسمت متناسب با آن، عکسی به عنوان background قرار دهید (و یا رنگ background را تغییر دهید) البته این مورد به جز صفحهٔ اصلی برای دیگر صفحات اجباری نیست و نمره اضافه‌ای نیز ندارد. لینک‌های مرتبط:

\href{https://pngtree.com/free-backgrounds}{\textcolor{blue}{\underline{\lr{background}}}} 
-
 \href{https://previews.123rf.com/images/ksanagraphica/ksanagraphica1709/ksanagraphica170900089/86527009-shopping-background-seamless-pattern-with-line-art-icons-monochrome-variant.jpg}{\textcolor{blue}{\underline{\lr{background 2 }}}}
 -
  \href{https://previews.123rf.com/images/vectorchef/vectorchef1503/vectorchef150302148/38121027-shopping-line-icon-pattern-set.jpg}{\textcolor{blue}{\underline{\lr{sale-background }}}} 
\end{itemize}
