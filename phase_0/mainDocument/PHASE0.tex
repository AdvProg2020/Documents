...
\item
ایجاد مخزن \lr{Github} و \lr{commit} نام و شماره دانشجویی در \lr{readme} (تسک به نفر اول \lr{assign} شود)

\item
کامیت نام و شماره دانشجویی در \lr{readme} (تسک به نفر دوم \lr{assign} شود)

\item
کامیت نام و شماره دانشجویی در \lr{readme} (تسک به نفر سوم \lr{assign} شود)
