...
در ابتدا شاید کشیدن \lr{UML} کمی سخت باشد اما به توجه به اینکه چیزی که شما می‌کشید مبنای شروع کد زنی شما برای فاز اول پروژه خواهد بود لازم است تا با تسلط تمام کشیده شود؛پس از پاک کردن و از اول شروع کردن در مرحله \lr{UML} نترسید! 
...
\item
نوع داده‌ای که تابع بر می‌گرداند \lr{(return type)} را  در انتهای خط پس از : مشخص کنید
...
\href{https://www.google.com}{\textcolor{blue}{\underline{نرم افزار \lr{Microsoft Visio}}}} 
...
\href{https://www.google.com}{\textcolor{blue}{\underline{سایت \lr{Draw.io}}}} 
