...
\item
عمومی یا \lr{public}؛ هر کسی می‌تواند تخته شما را رؤیت کند.
...
پس از ساخت \lr{Board}، اقدام به تعریف لیست‌های خود کنید. یکی از روش‌های تعریف لیست، تعیین وضعیت کار (\lr{task}) است. برای مثال تعریف‌شده، در حال پیگیری، در حال بازبینی و پایان یافته. لیست‌ها باید طوری تعریف شوند که یک \lr{Card} نتواند در دو لیست قرار گیرد.
